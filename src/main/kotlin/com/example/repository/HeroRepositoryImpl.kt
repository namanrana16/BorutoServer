...
class HeroRepositoryImpl():HeroRepository {
    ...
    override val page1 = listOf(
        ...
        Hero(
            ...
            about = "Sakura Uchiha (うちはサクラ, Uchiha Sakura, née Haruno (春野)) is a kunoichi of Konoha. When assigned to Team 7, Sakura finds herself ill-prepared for the duties of a shinobi.after training under Tsunade, she overcomes this, and becomes one of the greatest medical-nin in the world. But still Trash",
            rating = 0.0,
            power = 0,
            month = "Mar",
            day = "28th",
